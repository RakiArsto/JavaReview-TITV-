...
//		}
		for (int i = 0; i < danhSach.size(); i++) {
			System.out.println("Sinh viên thứ " + (i + 1) + ": " + danhSach.get(i));
        }
	}
	
	//3. Kiểm tra danh sách có rỗng hay không?
	public boolean ktDanhSachRong() {
	...
	//6. Kiểm tra xem sinh viên có tồn tại trong danh sách hay không, dựa trên mã sinh viên.
