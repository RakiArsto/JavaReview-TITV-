//Hiểu rõ cấu trúc Set trong Java - Bài tập rút thăm trúng thưởng
package main;
...
public class RutThamTrungThuong_TreeSet {
	...
	public boolean ktPhieuTonTai(String giaTri) {
		...
		do {
			...
			if(luaChon == 1 || luaChon == 2 || luaChon == 3) {
				...
				if(luaChon == 1) {
					...
					System.out.println("Kết quả kiểm tra: " + rt.ktPhieuTonTai(giaTri));
				}
			}
			else if(luaChon == 4) {
